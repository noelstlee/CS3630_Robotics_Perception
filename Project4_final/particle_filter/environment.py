...
def compute_detection_failure_rate(marker_measure: MarkerMeasure):
    ...
    Args:
        * marker_measure (MarkerMeasure): ground-truth depth, angle, lidar_range measurements of a marker.
    Return:
        * (float within lidar_range[0, 1]): probability that there is a detection failure of the marker by the robot.
    """
...
def compute_spurious_detection_rate(marker_measure: MarkerMeasure):
    ...
    Return:
        * (float within lidar_range[0, 1]): probability that the observation is a spurious detection.
    """
